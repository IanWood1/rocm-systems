...
SIMD_VOP1_UNARY: dict[str, tuple[str, str, str]] = {
    ...
    # All return uint32_t. Scan ops special-case the zero input to 0xFFFFFFFF,
    # matching the scalar bodies (std::countl_zero / countr_zero / popcount).
    # The VOP3 twins share these modifier-free integer bodies. f16<->f32
    # round-trip not involved -> not in _VOP3_UNARY_SKIP.
    #
